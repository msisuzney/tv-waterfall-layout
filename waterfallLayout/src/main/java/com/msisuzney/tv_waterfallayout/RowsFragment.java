 ...
 * <p>
 * 其中，绝对布局和水平方向滑动布局必须使用{@linkplain com.msisuzney.tv_waterfallayout.model.Collection} 提供宽高，
 * 以及必须使用{@linkplain com.msisuzney.tv_waterfallayout.model.Item}  提供布局中每个View的宽高和数据<br/><br/>
